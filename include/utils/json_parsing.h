...
/**
 * @brief Convert a json string into a vector of key-value pairs, e.g., "username=john%20Doe%20&password=test%40" turns into {'username':'john', 'password':'test@'}
 * 
 * @param body Raw JSON string from a Request Body.
 * @return std::string 
 */
inline std::unordered_map<std::string, std::string> parseJsonStringFromBody(const std::string &body)
{
